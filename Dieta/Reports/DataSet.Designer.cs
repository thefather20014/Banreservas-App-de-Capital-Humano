...
namespace Dieta.Reports {
    ...
    public partial class DataSet : global::System.Data.DataSet {
        ...
        public partial class USUARIOSDataTable : global::System.Data.TypedTableBase<USUARIOSRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public USUARIOSRow AddUSUARIOSRow(string USUARIO, string PASSWORD, int PERFIL) {
...
namespace Dieta.Reports.DataSetTableAdapters {
    ...
    public partial class USUARIOSTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [USUARIOS] ([USUARIO], [PASSWORD], [PERFIL]) VALUES (@USUARIO, @PASSW" +
                "ORD, @PERFIL)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [USUARIOS] SET [USUARIO] = @USUARIO, [PASSWORD] = @PASSWORD, [PERFIL] = @P" +
                "ERFIL WHERE (([ID] = @Original_ID))";
        ...
        public virtual int Insert(string USUARIO, string PASSWORD, int PERFIL) {
            if ((USUARIO == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[2].Value = ((int)(PERFIL));
        ...
        public virtual int Update(string USUARIO, string PASSWORD, int PERFIL, int Original_ID) {
            if ((USUARIO == null)) {
                throw new global::System.ArgumentNullException("USUARIO");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(PERFIL));
